...
import { pointer as d3pointer, Selection } from "d3-selection";
...
type RootSelection = Selection<SVGElement, unknown, any, unknown>
...
export default function addExcentricLabelingInteraction(
  ...
  function onMousemove(e: MouseEvent) {
    const [x, y] = d3pointer(e, groupOverlay.node());
